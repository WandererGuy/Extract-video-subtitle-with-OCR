...
SAVE_VIDEO_FRAME_FOLDER = "save_video_frame_folder"
...
if __name__ == '__main__':
    max_frame_count = 100
    source_folder = r"D:\WORK\Speech2text_dan_toc\Video tiếng dân tộc"
    for filename in os.listdir(source_folder):
        ...
        save_video_folder = create_save_video_folder(SAVE_VIDEO_FRAME_FOLDER, source_video)
